...
public class AdjacencyListGraphTest {
    ...
    public void testRemoveEdgeEdgeCases() {
        GraphAdjacentyList<Integer> graph = new GraphAdjacentyList<>();
    ...
    public void testDijkstraInterestingCase() {
        ...
        GraphAdjacentyList<Character> graph = new GraphAdjacentyList<>();
    ...
    public void testPrimStandardCase() {
        ...
        // Act
        GraphAdjacentyList<Integer> mstGraph = graph.primAL();
    ...
    public void testPrimInterestingCase() {
        ...
        GraphAdjacentyList<Character> mstGraph = graph.primAL();
    ...
    private <T> int countEdges(GraphAdjacentyList<T> graph) {
        int edgeCount = 0;
    ...
    public void testKruskalStandardCase() {
        ...
        GraphAdjacentyList<Integer> mstGraph = graph.kruskalAL();
    ...
    public void testKruskalInterestingCase() {
        ...
        GraphAdjacentyList<Character> mstGraph = graph.kruskalAL();
